...
type tools\ticked_file_enforcement\tests\warnings\unincluded_glob_matches_included_file.json | tools\bootstrap\python tools\ticked_file_enforcement\ticked_file_enforcement.py
